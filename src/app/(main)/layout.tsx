...
const AuthModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm rounded-[32px] bg-bg-base p-8 shadow-2xl ring-1 ring-white/10 animate-in zoom-in duration-300">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-text-main">로그인이 필요합니다</h3>
          <p className="mt-2 text-sm text-text-sub">여행의 순간을 기록하려면<br />먼저 로그인을 해주세요.</p>
          <button
            onClick={onClose}
